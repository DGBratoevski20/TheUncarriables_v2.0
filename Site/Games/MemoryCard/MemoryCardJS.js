...
let buttonPlayAgain = document
  .querySelector(".gameOverScreen")
...
timer.querySelector(
  "p"
).innerText = `Hours: ${hours} Min: ${minute} Sec: ${seconds}`;
  ...
  intervalForGameOver = setInterval(function () {
    ...
    if (findGameOver == mother.length) {
      ...
      document
        ...
        .querySelector("p").innerText += timer.querySelector("p").innerText;
    } else {
      findGameOver = 0;
    }
  }, 100);
