...
L.marker([48.30563, 14.28476],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Linz.</b><hr><i> One of the biggest cities in Austria.</i>')
.openPopup();

L.marker([47.06861, 15.44151],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Graz.</b><hr><i> One of the biggest cities in Austria.</i>')
.openPopup();

L.marker([47.81063, 13.05597],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Salzburg.</b><hr><i> One of the biggest cities in Austria.</i>')
.openPopup();

L.marker([47.27341, 11.40167],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Innsbruck.</b><hr><i> One of the biggest cities in Austria.</i>')
.openPopup();

L.marker([48.20967, 16.37328],{icon:leafletIcon}).addTo(map)
