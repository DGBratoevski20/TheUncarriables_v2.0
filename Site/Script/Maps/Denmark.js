...
.bindPopup('<b>Tivoli Gardens</b><hr><i>One of the most popular tourist destiantions in Austria.</i>')
.openPopup();

L.marker([55.73344656043942, 9.119701623628925],{icon:TouristDestinationsMarkerIcon}).addTo(map)
.bindPopup("<b>LEGO House</b><hr><i>One of the most popular tourist destiantions in Austria.</i>")
.openPopup();

L.marker([56.03917600283102, 12.621112283369962],{icon:TouristDestinationsMarkerIcon}).addTo(map)
.bindPopup('<b>Kronborg Slot</b><hr><i>One of the most popular tourist destiantions in Austria.</i>')
.openPopup();

L.marker([55.17638810915072, 10.490441404232339],{icon:TouristDestinationsMarkerIcon}).addTo(map)
.bindPopup('<b>Egeskov Castle</b><hr><i>One of the most popular tourist destiantions in Austria.</i>')
.openPopup();

L.marker([55.39958077725475, 10.393312429584304],{icon:TouristDestinationsMarkerIcon}).addTo(map)
.bindPopup('<b>Hans Christian Andersen Museum</b><hr><i>One of the most popular tourist destiantions in Austria.</i>')
.openPopup();

L.marker([56.223578192793454, 10.308977122037048],{icon:TouristDestinationsMarkerIcon}).addTo(map)
.bindPopup('<b>Den Gamle By</b><hr><i>One of the most popular tourist destiantions in Austria.</i>')
.openPopup();
