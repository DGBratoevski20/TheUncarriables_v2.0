...
L.marker([57.39884497483879, 21.55014710659771],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Ventspils.</b><hr><i> One of the biggest cities in Latvia.</i>')
.openPopup();

L.marker([56.96093619207526, 23.78874018624686],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Jūrmala.</b><hr><i> One of the biggest cities in Latvia.</i>')
.openPopup();

L.marker([56.65153464510933, 23.72320623118176],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Jelgava.</b><hr><i> One of the biggest cities in Latvia.</i>')
.openPopup();

L.marker([56.50627347991781, 21.010744000409918],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Liepāja.</b><hr><i> One of the biggest cities in Latvia.</i>')
.openPopup();

L.marker([55.8775557008804, 26.53266705226049],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Daugvpils.</b><hr><i> One of the biggest cities in Latvia.</i>')
.openPopup();

L.marker([56.948491643410236, 24.11069035433517],{icon:leafletIcon}).addTo(map)
