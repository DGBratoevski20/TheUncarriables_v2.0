...
L.marker([55.7457984437633, 24.35109526451854],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Panevėžys.</b><hr><i> One of the biggest cities in Lithuania.</i>')
.openPopup();

L.marker([55.94981948011651, 23.317505540676695],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Šiauliai.</b><hr><i> One of the biggest cities in Lithuania.</i>')
.openPopup();

L.marker([55.70819598338497, 21.143975513138106],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Klaipėda.</b><hr><i> One of the biggest cities in Lithuania.</i>')
.openPopup();

L.marker([54.90676677054016, 23.90542723575055],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Kaunas.</b><hr><i> One of the biggest cities in Lithuania.</i>')
.openPopup();

L.marker([54.693044937555925, 25.286213984496587],{icon:leafletIcon}).addTo(map)
