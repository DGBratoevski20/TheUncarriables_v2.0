...
L.marker([35.910824921615955, 14.50280230389274],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Sliema.</b><hr><i> One of the biggest cities in Malta.</i>')
.openPopup();

L.marker([35.89504007609341, 14.466460745410323],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Birkirkara.</b><hr><i> One of the biggest cities in Malta.</i>')
.openPopup();

L.marker([35.89877173968337, 14.514370904818078],{icon:leafletIcon}).addTo(map)
