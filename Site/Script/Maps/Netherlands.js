...
L.marker([52.072509777275876, 4.298209580307056],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>The Hague.</b><hr><i> One of the biggest cities in Netherlands.</i>')
.openPopup();

L.marker([51.93585750763058, 4.474379115296331],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Rotterdam.</b><hr><i> One of the biggest cities in Netherlands.</i>')
.openPopup();

L.marker([52.09859240224668, 5.121858732711509],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Utrecht.</b><hr><i> One of the biggest cities in Netherlands.</i>')
.openPopup();

L.marker([52.37511137109779, 4.902678761742699],{icon:leafletIcon}).addTo(map)
