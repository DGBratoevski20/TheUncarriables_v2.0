...
L.marker([48.311791651899036, 18.070614006567418],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Nitra.</b><hr><i> One of the biggest cities in Slovakia.</i>')
.openPopup();

L.marker([48.74167045870027, 19.1424918664681],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>.</b><hr><i> One of the biggest cities in Slovakia.</i>')
.openPopup();

L.marker([49.217418140637655, 18.738528627520484],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Žilina.</b><hr><i> One of the biggest cities in Slovakia.</i>')
.openPopup();

L.marker([49.002469539522856, 21.23720083735469],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Prešov.</b><hr><i> One of the biggest cities in Slovakia.</i>')
.openPopup();

L.marker([48.72203788044131, 21.256532952408698],{icon:leafletIcon}).addTo(map)
.bindPopup('<b>Košice.</b><hr><i> One of the biggest cities in Slovakia.</i>')
.openPopup();

L.marker([48.15043737772495, 17.100639332663736],{icon:leafletIcon}).addTo(map)
